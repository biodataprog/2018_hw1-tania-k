...
head -11 Nc20H.expr.sorted.tab

#5. Finding and Counting

wget https://biodataprog.github.io/2018_programming-intro/data/D_mel.63B12.gbk
grep -i -c 'CDS  ' D_mel.63B12.gbk
sort -k3 -n -r Ecoli-vs-Yersinia.BLASTP.tab | cut -f1,3 | grep -c 100.00
awk ' $3 > 90.00 {print $1, $3}' Ecoli-vs-Yersinia.BLASTP.tab | wc -l
